...
\setlength{\parskipGlobal}{1.50ex}
...
\setlist[itemize]{
	...
	itemsep = 0.50ex,  % Reducción atómica a solo ~1pt
	%
	% Control interlineado parrafo antes de listas.
	parsep = 0pt,        % Eliminación total de la herencia del parskip global
	topsep = 0ex       % Controlás milimétricamente el espacio con el texto de arriba
}
